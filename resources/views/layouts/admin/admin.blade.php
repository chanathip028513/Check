  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="font-family:'Mali', cursive;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{route('index')}}" class="d-block" style="margin-left: 6px">{{Auth::user() ->name}}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('header')}}" class="nav-link">
              <i class="fas fa-heading ml-1" style="padding-right: 10px"></i>              
              <p>
                Header
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="{{route('body')}}" class="nav-link">
              <i class="far fa-file ml-1" style="padding-right: 11px; font-size: 21px"></i>        
              <p>
                Body
              </p>
            </a>
